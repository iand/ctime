...
func (i Interval) Contains(t time.Time) bool {
	return i.Duration() != 0 && t.Before(i.End) && !t.Before(i.Start)
}
...
func (i Interval) Before(n Interval) bool {
	return i.Duration() != 0 && n.Duration() != 0 && i.End.Before(n.Start)
}
...
func (i Interval) Overlaps(n Interval) bool {
	...
	return i.Duration() != 0 && n.Duration() != 0 && i.Start.Before(n.Start) && n.Start.Before(end) && end.Before(n.End)
}
...
func (i Interval) During(n Interval) bool {
	return i.Duration() != 0 && n.Duration() != 0 && n.Start.Before(i.Start) && i.End.Before(n.End)
}
...
func (i Interval) Meets(n Interval) bool {
	return i.Duration() != 0 && n.Duration() != 0 && i.End == n.Start
}
...
func (i Interval) Starts(n Interval) bool {
	return i.Duration() != 0 && n.Duration() != 0 && i.Start == n.Start && i.End.Before(n.End)
}
...
func (i Interval) Finishes(n Interval) bool {
	return i.Duration() != 0 && n.Duration() != 0 && n.Start.Before(i.Start) && i.End == n.End
}
...
func (i Interval) Equals(n Interval) bool {
	return i.Duration() != 0 && n.Duration() != 0 && i.Start == n.Start && i.End == n.End
}
...
func (i Interval) Intersects(n Interval) bool {
	return i.Duration() != 0 && n.Duration() != 0 && n.Start.Before(i.End) && i.Start.Before(n.End)
}
